...
public class Room5 extends JPanel implements KeyListener, MouseListener, Room
{
   // Movement vars
   Collisable player; 
   Collisable door;
   ...
   public void paintComponent(Graphics g)
   {
      ...
      if(myComputerPower == true && myLightPower == false)
      {
      ...
      else if(myLightPower == false)
      {
         ...
         g.drawString("Searching...", 100, 50);
         
         g.setColor(Color.WHITE);
         g.drawString("137", 700, 245);
         
         g.setColor(Color.WHITE);
         g.drawString("Cathrine Fan", 1500, 950);
         
         Color darkRays = new Color(0,0,0,230);
         g.setColor(darkRays);
         g.fillRect(0, 0, 1650, 1080);
      }
      ...
      if(myComputerPower == true && myLightPower == false)
      {
         Color computerLight = new Color(255,255,255,16);
         g.setColor(computerLight);
         g.fillOval(-50,-375, 1550, 1550);
         computerLight = new Color(0,255,255,16);
         g.setColor(computerLight);
         g.fillOval(-50, -375, 1550, 1550);
         computerLight = new Color(255,255,255,32);
         g.setColor(computerLight);
         g.fillOval(450,125, 550, 550);
         computerLight = new Color(0,255,255,32);
         g.setColor(computerLight);
         g.fillOval(450,125, 550, 550);
         computerLight = new Color(255,255,255,64);
         g.setColor(computerLight);
         g.fillOval(600,275, 250, 250);
         computerLight = new Color(0,255,255,64);
         g.setColor(computerLight);
         g.fillOval(600,275, 250, 250);
         computerLight = new Color(255,255,255,128);
         g.setColor(computerLight);
         g.fillOval(675,350, 100, 100);
         computerLight = new Color(0,255,255,128);
         g.setColor(computerLight);
         g.fillOval(675,350, 100, 100);
         g.setColor(Color.GREEN);
         myComputer.drawTo(g);
   ...
   public int mainLoop()
   {
      ...
      { 
         ...
         if(player.intersects(door) && myComputerPower == true && myLightPower == false)
         {
            return 6;
         }
